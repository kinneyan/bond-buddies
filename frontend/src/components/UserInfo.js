...
const getTestResults = async event =>
{
    try
    {
        ...
        {
                if(res.personality.description.buddyType)
                    buddyType = res.personality.description.buddyType
                else if(res.disc.description.buddyType)
                {
                    buddyType = res.disc.description.buddyType
                    console.log("here")
                }
    ...
    return (
          ...
          <div className="content">
              <div className="left-content">
                  ...
                  <img id="buddyImg" src={prof} className="rounded-circle" style={{border: '3px solid black', position: 'relative', bottom: '10px', left: '1vh', width: '88px', height: '88px' }} />
                  <h2 id="type">No buddy Type</h2>
                  <p id="descrip"></p>
              </div>
